...
readonly EXPECTED_VERSION="7:7.1.5-0+deb13u1+h10.7"
...
dpkg-deb --fsys-tarfile "$ffmpeg_deb" \
  ...
  | gzip -dc \
  | grep -Fq \
    'H10: backport IAMF, DVB subtitle, CFHD, MPEG-PS, librist, VC-2 RTP, DASH, swscale, and HEVC hvcC fixes; disable IAMF, libssh/SFTP, and librist/RIST.'
