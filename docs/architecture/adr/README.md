...
| [006](./006-c2pa-content-credentials.md) | C2PA and visible disclosure for AI-generated media | Accepted | 采用 C2PA + strict sidecar + 可见 AI 标签；本地 Reader 回读不等于受信证书、独立验证、平台保留或法律合规 |
