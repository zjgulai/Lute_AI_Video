...
- **当前 AI Video 2.0 实施计划**：`docs/superpowers/plans/2026-06-04-ai-video-2-0-remaining-implementation-plan.md` 是 C15-C22 的当前执行计划；C1-C20 最高证据等级保持 `L2-fixture-or-dry-run`，C21 仍需用户再次明确授权后才能进入局部 `L4-authorized-live`。
