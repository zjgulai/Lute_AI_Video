...
| TODO-P1-5 | S2 full-media 分段计划 | p1_5a_no_provider_contract_passed_live_segments_blocked | `media_stop_step` 合同与 no-provider 越界测试已完成；下一步只能逐段授权 TTS / thumbnail / assemble / audit live smoke | 每个 stop point 单独 spec、单独预算、单独止损；不得一次跑完整链 |
