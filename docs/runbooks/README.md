...
| [c2pa-dry-run-checklist.md](./c2pa-dry-run-checklist.md) | C2PA 签名链路未申请证书 dry-run 验证（签名退化、manifest 与预检边界） | 5-15 min |
| [c2pa-cert-application.md](./c2pa-cert-application.md) | C2PA 证书申请、钥匙托管边界与 EU 签发链路合规 | 30-60 min |
...
*Last synced: 2026-07-18 — configs/ (35 files) ↔ docs/runbooks/ (48 files); provider-cost Task 10 is `completed_local / independent_review=true` with local-only evidence.*
