...
class BaseRepository:
    ...
    _ALLOWED_FIELDS: dict[str, set[str]] = {
        ...
        "pipeline_states": {"id", "label", "scenario", "config", "steps", "current_step", "mode", "errors", "media_synthesis_errors", "gates", "schema_version", "pipeline_degraded", "degraded_reason", "trace_id", "structured_errors", "created_at", "updated_at"},
