...
def test_lighthouse_rsync_artifact_contract_and_runbook_are_documented():
    ...
    for token in [
        ...
        "landing_sidecar_sync_exact_systems_only",
        "landing_sidecar_sync_remote_baseline_cas",
        "landing_sidecar_sync_atomic_activation",
        "landing_sidecar_sync_verified_backup_and_receipt",
        "landing_sidecar_sync_pinned_known_hosts",
        "landing_sidecar_rollback_cas",
        "landing_sidecar_ambiguous_state_is_inspectable",
        "landing_sidecar_read_only_inspector",
        "landing_sidecar_transaction_tests",
        "landing_sidecar_recovery_tests",
