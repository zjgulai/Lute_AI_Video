    ...
    <div className="apple-card p-3 bg-white space-y-3">
      {(script.segments || []).map((seg: any, i: number) => (
        <div key={i} className="space-y-2">
          ...
          <div>
            <label className="block text-[10px] font-medium text-[#86868b] mb-0.5">{t("editors.voiceover")}</label>
            <textarea
              value={seg.voiceover || ""}
          ...
          <div>
            <label className="block text-[10px] font-medium text-[#86868b] mb-0.5">{t("editors.visual_desc")}</label>
            <textarea
