...
import { fetchToolboxTools, type ToolboxToolId, type ToolboxToolSummary } from "@/components/api";
...
const TOOL_ORDER: ToolboxToolId[] = [
  "product-image",
  "six-view",
  "ecommerce-visual",
  "digital-human",
...
const TOOL_PRESENTATION: Record<ToolboxToolId, ToolPresentation> = {
  "product-image": {
    id: "product-image",
                    ...
                    <div className="space-y-4">
                      ...
                      <dl className="space-y-2 text-xs text-[var(--text-muted)]">
                        <div>
                          ...
                          <dd className="mt-1 leading-5">{joinValues(outputTypes)}</dd>
                        </div>
                        <div>
                          <dt className="font-semibold text-[var(--text-body)]">{t("toolbox.scenarios")}</dt>
                          <dd className="mt-1 leading-5">{joinValues(scenarios)}</dd>
                        </div>
                        <div>
                          <dt className="font-semibold text-[var(--text-body)]">{t("toolbox.checks")}</dt>
                          <dd className="mt-1 leading-5">{joinValues(checks)}</dd>
                        </div>
                      </dl>
                    </div>
                    <Link
