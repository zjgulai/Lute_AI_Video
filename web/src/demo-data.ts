...
// ═══ 会说话的 UI 2.0 — 快捷模板预设（基于 momcozy.com 真实数据）═══

export const TEMPLATE_PRESETS: TemplatePreset[] = [
  // ── 商品直拍 — 来自 momcozy.com 真实数据（自动生成 by scripts/scrape_momcozy.py）──
  {
    id: "momcozy-momcozy-kleanpal-pro-baby-bottle-washer",
    name: "Momcozy KleanPal Pro Baby Bottle Washer and Sterilizer",
    nameEn: "Momcozy KleanPal Pro Baby Bottle Washer and Sterilizer",
    description: "momcozy.com 官方产品页 $299.99",
    descriptionEn: "Official momcozy.com product page $299.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "Momcozy KleanPal Pro Baby Bottle Washer and Sterilizer",
      brand_name: "Momcozy",
      key_features: "Bottle Sterilizer And Dryer\nBottle Washer\nBreastfeeding supplies\nThe best baby bottle washer and sterilizer for automatic cleaning & sterilizing.\nThis electric bottle washer, sterilizer & dryer saves time & energy – a must-have for busy parents!",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-m5-smart-wearable-breast-pump-upgraded-w",
    name: "M5 Smart Wearable Breast Pump – Upgraded with App Control",
    nameEn: "M5 Smart Wearable Breast Pump – Upgraded with App Control",
    description: "momcozy.com 官方产品页 $119.99",
    descriptionEn: "Official momcozy.com product page $119.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "M5 Smart Wearable Breast Pump – Upgraded with App Control",
      brand_name: "Momcozy",
      key_features: "Breastfeeding supplies\nM5 Smart\nWearable Breast Pump\nDiscover the Momcozy M5 Smart: the app-controlled upgrade to our best-selling M5.\nGet the same strong suction and integrated design, with smart tracking at the same great price!",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-momcozy-mobile-style-hands-free-breast-p",
    name: "Momcozy Mobile Style™ Hands-free Slim Breast Pump | M6",
    nameEn: "Momcozy Mobile Style™ Hands-free Slim Breast Pump | M6",
    description: "momcozy.com 官方产品页 $129.99",
    descriptionEn: "Official momcozy.com product page $129.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "Momcozy Mobile Style™ Hands-free Slim Breast Pump | M6",
      brand_name: "Momcozy",
      key_features: "Breastfeeding supplies\nM6\nWearable Breast Pump",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  ...
  {
    id: "momcozy-momcozy-mobile-flow-hands-free-breast-pu",
    name: "Momcozy Mobile Flow™ Hands-Free Breast Pump | M9",
    nameEn: "Momcozy Mobile Flow™ Hands-Free Breast Pump | M9",
    description: "momcozy.com 官方产品页 $159.99",
    descriptionEn: "Official momcozy.com product page $159.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "Momcozy Mobile Flow™ Hands-Free Breast Pump | M9",
      brand_name: "Momcozy",
      key_features: "Breastfeeding supplies\nM9\nWearable Breast Pump\nMomcozy M9 hands-free breast pump combines powerful 300mmHg suction, 15 intensity settings, and app control for a personalized experience.",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-momcozy-wellness-1-warm-massage-wearable",
    name: "Momcozy Wellness 1 Warm-Massage Wearable Breast Pump - W1",
    nameEn: "Momcozy Wellness 1 Warm-Massage Wearable Breast Pump - W1",
    description: "momcozy.com 官方产品页 $329.99",
    descriptionEn: "Official momcozy.com product page $329.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "Momcozy Wellness 1 Warm-Massage Wearable Breast Pump - W1",
      brand_name: "Momcozy",
      key_features: "Breastfeeding supplies\nW1\nWearable Breast Pump\nExperience the ultimate comfort with our warm-massage breast pump.\nThis wearable, heated breast pump uses gentle massage technology to promote better milk flow.",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-momcozy-5-inch-dual-mode-smart-baby-moni",
    name: "Momcozy 5-Inch Dual-mode Smart Baby Monitor with 2 Camera -BM04",
    nameEn: "Momcozy 5-Inch Dual-mode Smart Baby Monitor with 2 Camera -BM04",
    description: "momcozy.com 官方产品页 $219.99",
    descriptionEn: "Official momcozy.com product page $219.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "Momcozy 5-Inch Dual-mode Smart Baby Monitor with 2 Camera -BM04",
      brand_name: "Momcozy",
      key_features: "Baby Care\nBaby Monitor\nBaby Safety\nBaby Watch\nBest Baby Monitor",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-momcozy-2-in-1-electric-baby-swing",
    name: "Momcozy 2-in-1 Electric Baby Swing",
    nameEn: "Momcozy 2-in-1 Electric Baby Swing",
    description: "momcozy.com 官方产品页 $159.99",
    descriptionEn: "Official momcozy.com product page $159.99",
    scene: "brand_vlog",
    videoType: "product_explain",
    values: {
      product_name: "Momcozy 2-in-1 Electric Baby Swing",
      brand_name: "Momcozy",
      key_features: "Discover the Momcozy 2-in-1 Baby Swing.\nFeatures patented natural motion, ergonomic reclining, and dual-arm support for infants up to 66 lbs.\nGive your baby the best in comfort.",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-2-in-1-spray-suction-electric-nasal-aspi",
    name: "Momcozy BreezyClear™ 2-in-1 Spray & Suction Electric Nasal Aspirator",
    nameEn: "Momcozy BreezyClear™ 2-in-1 Spray & Suction Electric Nasal Aspirator",
    description: "momcozy.com 官方产品页 $49.99",
    descriptionEn: "Official momcozy.com product page $49.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "Momcozy BreezyClear™ 2-in-1 Spray & Suction Electric Nasal Aspirator",
      brand_name: "Momcozy",
      key_features: "Baby\nBaby Nasal Aspirator\nNasal Aspirator\nClear baby congestion faster with Momcozy’s 2-in-1 electric nasal aspirator.\nGentle mist spray, hospital-grade suction, 4 suction levels, lights and lullabies.",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-momcozy-ergowrap-postpartum-belly-band",
    name: "Momcozy Ergowrap™ Postpartum Belly Wrap - Postpartum Belly Band",
    nameEn: "Momcozy Ergowrap™ Postpartum Belly Wrap - Postpartum Belly Band",
    description: "momcozy.com 官方产品页 $79.99",
    descriptionEn: "Official momcozy.com product page $79.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "Momcozy Ergowrap™ Postpartum Belly Wrap - Postpartum Belly Band",
      brand_name: "Momcozy",
      key_features: "Pregnancy Belt\nMomcozy postpartum belly wrap offers 3D lifting compression & stability.\nIdeal C-section belly band with breathable fabric for diastasis recti recovery.",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-momcozy-bellyembrace-maternity-belly-ban",
    name: "BumpEase - Momcozy Ergonest Maternity Belly Band",
    nameEn: "BumpEase - Momcozy Ergonest Maternity Belly Band",
    description: "momcozy.com 官方产品页 $59.99",
    descriptionEn: "Official momcozy.com product page $59.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "BumpEase - Momcozy Ergonest Maternity Belly Band",
      brand_name: "Momcozy",
      key_features: "Pregnancy Belt\nFind comfort during pregnancy with our maternity belly band.\nCrafted from soft, breathable fabric and featuring a 3D molded design, this belly band provides gentle belly and back support.",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-portable-milk-warmer-22oz-cooler-on-the-",
    name: "On-the-Go Bundle: Portable Baby Bottle Warmer + 22oz Baby Bottle Cooler",
    nameEn: "On-the-Go Bundle: Portable Baby Bottle Warmer + 22oz Baby Bottle Cooler",
    description: "momcozy.com 官方产品页 $147.99",
    descriptionEn: "Official momcozy.com product page $147.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "On-the-Go Bundle: Portable Baby Bottle Warmer + 22oz Baby Bottle Cooler",
      brand_name: "Momcozy",
      key_features: "Momcozy makes high-quality breast pumps, nursing bras, baby carriers, and care essentials.\nDesigned for comfort & convenience.\nTrusted by 4.5M+ moms worldwide.",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },
  {
    id: "momcozy-momcozy-pro-collagen-belly-firming-moist",
    name: "Momcozy Pro-Collagen Belly Firming Moisturizer",
    nameEn: "Momcozy Pro-Collagen Belly Firming Moisturizer",
    description: "momcozy.com 官方产品页 $14.99",
    descriptionEn: "Official momcozy.com product page $14.99",
    scene: "product_direct",
    videoType: "product_explain",
    values: {
      product_name: "Momcozy Pro-Collagen Belly Firming Moisturizer",
      brand_name: "Momcozy",
      key_features: "Helps improve the appearance of Skin Elasticity &amp; FirmnessSmooths &amp; Reduces the Appearance of Stretch MarksFast-Absorbing \"Fresh-Lock\" Oil-in-CreamSuitable for Pregnancy, Breastfeeding &amp; Postpartum",
      brand_voice: "温暖、真实、像妈妈之间分享 / warm, real, mom-to-mom sharing",
    },
  },

  // ── 品牌宣传片 brand_campaign ──
  {
    id: "momcozy-mothers-day-2026",
    name: "Momcozy 母亲节 2026 — Choose You, Too",
    nameEn: "Momcozy Mother's Day 2026 — Choose You, Too",
    description: "当前活动主题（20% off storewide）",
    descriptionEn: "Current campaign (20% off storewide)",
    scene: "brand_campaign",
    videoType: "brand_image",
    values: {
      brand_name: "Momcozy",
      campaign_theme: "Mother's Day 2026 — Choose You, Too",
      brand_values: "为妈妈的舒适不断进化。提醒每一位妈妈：在照顾宝宝的同时，也别忘了选择自己",
      target_audience: "25-38 岁的新手 / 经历过哺乳的妈妈，节日礼赠场景",
      visual_identity: "温暖自然光、居家场景、柔和色调、母婴互动情感镜头",
    },
  },
  {
    id: "momcozy-brand-evolution",
    name: "Momcozy 品牌形象 — Maximizing Comfort",
    nameEn: "Momcozy Brand Image — Maximizing Comfort",
    description: "全球 500 万 + 妈妈选择的品牌叙事",
    descriptionEn: "Global brand narrative — chosen by 5M+ moms",
    scene: "brand_campaign",
    videoType: "brand_image",
    values: {
      brand_name: "Momcozy",
      campaign_theme: "Maximizing Comfort for Moms at Every Step",
      brand_values: "覆盖孕期 → 产后 → 哺乳 → 育儿全周期，全球超过 500 万妈妈的选择",
      target_audience: "全球妈妈群体，从备孕到 3 岁宝妈",
      visual_identity: "纪录片级真实感、自然光、不同肤色不同年龄段妈妈群像、温暖米色 + 柔粉主调",
    },
  },

  // ── 网红二创 influencer_remix ──
  {
    id: "momcozy-kleanpal-ugc-remix",
    name: "Momcozy KleanPal Pro UGC 二创",
    nameEn: "Momcozy KleanPal Pro UGC Remix",
    description: "基于 momcozy.com 上 12 个真实 UGC 视频",
    descriptionEn: "Based on 12 real UGC videos on momcozy.com",
    scene: "influencer_remix",
    videoType: "influencer_remix",
    values: {
      video_url: "https://momcozy.com/products/momcozy-kleanpal-pro-baby-bottle-washer",
      product_name: "Momcozy KleanPal Pro Baby Bottle Washer",
      influencer_name: "Verified Buyer (UGC)",
      keep_original_audio: "false",
    },
  },
  {
    id: "momcozy-m5-ugc-remix",
    name: "Momcozy M5 妈妈分享二创",
    nameEn: "Momcozy M5 Mom Share Remix",
    description: "基于 1,433 条 M5 真实评价",
    descriptionEn: "Based on 1,433 real M5 reviews",
    scene: "influencer_remix",
    videoType: "influencer_remix",
    values: {
      video_url: "https://momcozy.com/products/m5-smart-wearable-breast-pump-upgraded-with-app-control",
      product_name: "Momcozy M5 Smart Wearable Breast Pump",
      influencer_name: "Mom Reviewer",
      keep_original_audio: "false",
    },
  },

  // ── 实拍素材 live_shoot_to_video ──
  {
    id: "momcozy-kleanpal-live",
    name: "Momcozy KleanPal Pro 实拍合成",
    nameEn: "Momcozy KleanPal Pro Live Footage",
    description: "上传家庭实拍，AI 自动生成旁白 + 字幕",
    descriptionEn: "Upload home footage, AI generates voice-over + captions",
    scene: "live_shoot_to_video",
    videoType: "live_shoot",
    values: {
      product_name: "Momcozy KleanPal Pro Baby Bottle Washer",
      brand_name: "Momcozy",
      topic: "新生儿家庭一天 — 用 KleanPal Pro 解放双手",
    },
  },

  // ── 品牌 VLOG brand_vlog ──
  {
    id: "momcozy-living-room-vlog",
    name: "Momcozy 客厅 VLOG — KleanPal Pro 日常",
    nameEn: "Momcozy Living Room VLOG — KleanPal Pro Daily",
    description: "居家温馨场景，宝宝沉睡 + 妈妈轻松",
    descriptionEn: "Cozy home scene, baby asleep + mom relaxed",
    scene: "brand_vlog",
    videoType: "brand_vlog",
    values: {
      brand_id: "momcozy",
      scene_id: "living-room",
      story_description:
        "年轻妈妈在客厅沙发上喝咖啡，背景里 KleanPal Pro 静静地清洗奶瓶。宝宝在旁边的婴儿摇椅上酣睡。开场 3 秒展示妈妈眼神放松，中段切到 KleanPal Pro 的 26 喷射口工作画面（30 秒倒计时显示快洗模式），结尾妈妈抱起醒来的宝宝微笑——'It's like having an extra set of hands around the house'。",
      video_duration: "30",
    },
  },
  {
    id: "momcozy-bedroom-vlog",
    name: "Momcozy 卧室 VLOG — M5 夜泵场景",
    nameEn: "Momcozy Bedroom VLOG — M5 Night Pumping",
    description: "夜间静音泵奶 + 宝宝安睡",
    descriptionEn: "Silent night pumping + baby sleeping",
    scene: "brand_vlog",
    videoType: "brand_vlog",
    values: {
      brand_id: "momcozy",
      scene_id: "bedroom",
      story_description:
        "夜深人静的卧室，妈妈穿着 M5 智能吸奶器躺在床上看书，APP 显示实时奶量曲线。宝宝在婴儿床里安睡（特写宝宝呼吸的特写）。M5 完全静音，整个场景只有翻书声和宝宝呼吸声。结尾妈妈合上书，画面定格 'Comfort Fit · Steady Output · Hands-Free'。",
      video_duration: "30",
    },
  },
  ...
  // ── 快速模式 fast_mode ──
  {
    id: "momcozy-fast-test",
    name: "Momcozy 产品快速测试",
    nameEn: "Momcozy Product Quick Test",
    description: "10 秒快速测试 — Momcozy 母婴场景",
    descriptionEn: "10s quick test — Momcozy maternal scene",
    scene: "fast_mode",
    videoType: "quick_test",
    values: {
      user_prompt:
        "Momcozy KleanPal Pro bottle washer in a sunlit kitchen, mother in cozy sweater pouring coffee, infant cooing in baby seat nearby, soft natural light, warm color palette, ASMR-quiet ambient sound, iPhone-cinematic aesthetic",
      duration: "10",
    },
  },
  ...
  // ── 通用 ──
  {
    ...
    description: "从零开始，自定义所有字段",
    descriptionEn: "Start from scratch, customize all fields",
    scene: "product_direct",
    videoType: "product_explain",
    values: {},
  },
